...
<>
<TopBar/>
<aside id="logo-sidebar" className="fixed top-0 left-0 z-40 w-[24rem] overflow-y-none   h-dvh pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
   <div className="h-full px-3 pb-4 overflow-y-auto overscroll-none overflow-none bg-white dark:bg-gray-800">
      <ul className="space-y-2 font-medium">
        ...
        <li>
         ...
         <div className="container mx-2 h-[35rem] z-50 overflow-y-scroll ">
